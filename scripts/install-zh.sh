...
info "Installing Deepy with Python 3.13 using the Tsinghua PyPI mirror for this command only."
info "This script does not modify uv.toml, pip.conf, or persistent Python tooling configuration."
"$UV_BIN" tool install --python 3.13 deepy-cli --default-index "$TUNA_INDEX"
